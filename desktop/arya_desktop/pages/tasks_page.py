...
class TasksPage(QWidget):
    """Loads and displays tasks from GET /tasks."""
    ...
    def __init__(self, api_client: ApiClient | None = None):
        ...
        self._build_ui()
        self.status_label.setText("Click Refresh to load tasks.")
    ...
    def _build_ui(self) -> None:
        ...
        subtitle = QLabel("Loaded from /tasks")
    ...
    def refresh(self) -> None:
        ...
        try:
            ...
            self.status_label.setText(f"Could not load tasks: {error}")
            return

        self.status_label.setText(f"{len(tasks)} task(s)")

        if not tasks:
            self._add_empty("No tasks yet.")
            return
